...
- [Adding a device group](Device_Groups.mdx)
- [Removing a device group](Device_Groups.mdx)
- [Exporting devices to a CSV file](Device_Groups.mdx)
...
If you cannot see the **Device Groups** page, it might be that you do not have the required permissions. You need one of the following [roles](User_Roles.mdx)
