...
3. Click **Add recepient**. The **Add Recipient** pop-up is displayed.
4. In the **Add Recipient** pop-up, update the following fields:\* Recipient Email ID - Enter the email ID of the recipient for whom the notification has to be sent.
