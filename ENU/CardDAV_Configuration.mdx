...
| Per-App VPN                 | **Prerequisite**: Configure Tunnel or any per-app VPN configuration before configuring per-app VPN in CardDAV configuration.From the drop-down menu, select the pre-configured per-app VPN configuration.**Applicable to**: iOS 14+ |
| iOS 10+                     |                                                                                                                                                                                                                                     |
