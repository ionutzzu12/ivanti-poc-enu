...
- [Creating the Android Work Challenge configuration:](Android_Work_Challenge.mdx)
- [Configuration Setup settings](Android_Work_Challenge.mdx)
...
2. :inlineImage[]{src="https://api.archbee.com/api/optimize/BbT7KQqqvz3LSYn2rwmao/1eY47BPxjy-M-iw6cL9te_r43workchallenge001.png" alt caption}
   Click **+Add**.
3. :inlineImage[]{src="https://api.archbee.com/api/optimize/BbT7KQqqvz3LSYn2rwmao/K7oxFe1jRlndgiWeHVO_D_r43workchallenge002.jpg" alt caption}
   Type "work" in the search field.
4. Select the  **Android Work Challenge** configuration.
5. :inlineImage[]{src="https://api.archbee.com/api/optimize/BbT7KQqqvz3LSYn2rwmao/K6p79vSnALXY5l2NlC5dq_r44workchallenge003.png" alt caption}
   Enter a name for the configuration, and, optionally, a description.
6. Use the Configuration Setup fields to create the configuration. Refer to [Configuration Setup settings](Android_Work_Challenge.mdx) for details on the settings.
7. Click **Next ->**.
8. :inlineImage[]{src="https://api.archbee.com/api/optimize/BbT7KQqqvz3LSYn2rwmao/lLSBELnpAQlnVE-ltXrqG_r43workchallenge004.png" alt caption}
