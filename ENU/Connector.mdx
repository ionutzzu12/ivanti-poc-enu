...
<Image src="Sync_icon.png" size="10" isUploading="false" initialPath="Sync_icon.png" githubPath="ENU/Sync_icon.png" position="flex-start" indent="2"></Image>
...
<Image src="Cancel_icon.png" size="10" isUploading="false" initialPath="Cancel_icon.png" githubPath="ENU/Cancel_icon.png" position="flex-start" indent="2"></Image>
...
<Image src="Fetch_icon.png" size="10" isUploading="false" initialPath="Fetch_icon.png" githubPath="ENU/Fetch_icon.png" position="flex-start" indent="2"></Image>
...
<Image src="Download_icon.png" size="10" isUploading="false" initialPath="Download_icon.png" githubPath="ENU/Download_icon.png" position="flex-start" indent="2"></Image>
...
If you cannot see the **Connector** page, it might be that you do not have the required permissions. You need one of the following [roles](User_Roles.mdx):
