...
- [Creating a dynamically managed user group](User_Groups.mdx)
- [Creating a manually managed user group](User_Groups.mdx)
- [Creating a user group from one of the duplicate user groups](User_Groups.mdx)
- [Creating a user group by CSV file upload](User_Groups.mdx)

Create a user group so that you can assign apps and [roles](User_Roles.mdx) to multiple users. For example, you might create a Managers group if you want all department managers to be administrators for apps and content.
...
If you cannot perform tasks on the **Users Groups** page, it might be that you do not have the required permissions. You need one of the following [roles](User_Roles.mdx):
