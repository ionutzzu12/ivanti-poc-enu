...
- If you are using Microsoft AD, or another on-premise LDAP directory, you will need to set up Connector to connect to and import users to Ivanti Neurons for MDM. Set up Connector or [LDAP](Configuring_LDAP_server.mdx) if you have not done so already.
...
<Image src="Resources/Images/idp001.png" size="32" isUploading="false" initialPath="Resources/Images/idp001.png" githubPath="ENU/Resources/Images/idp001.png" position="flex-start" indent="2"></Image>
...
If you cannot see the Identity page, it might be that you do not have the required permissions. You need one of the following [roles](User_Roles.mdx):
