...
After you create custom attributes, you can assign them to one or more applications. Each attribute has a corresponding value that you can use for tasks such as creating application groups. For more information about managing attributes, see [Attributes](Attributes.mdx).
