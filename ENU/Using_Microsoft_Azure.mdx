...
- [Setting up Entra ID account](Using_Microsoft_Azure.mdx)
- [Creating Users on Entra ID](Using_Microsoft_Azure.mdx)
- [Connecting Entra ID to UEM for Windows 10 Devices](Using_Microsoft_Azure.mdx)
- [Multi-User Support for Windows devices](Using_Microsoft_Azure.mdx)
...
2. Complete the UEM setup steps described in the section, [Entra ID Windows 10 Unified Endpoint Management Setup](Entra_ID_Windows_10_Unified_Endpoint_Management_Setup.mdx)
3. Complete the [Assigning Entra ID UEM app](Assigning_Entra_ID_UEM_app.mdx) setup in the Azure portal.
...
Microsoft Passport for Work is replaced with Windows Hello for Business. For more Information, see [Windows Hello for Business Configuration](Windows_Hello_for_Business_Configuration.mdx).
