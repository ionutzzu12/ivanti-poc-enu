...
<Image src="Resources/Images/googlebc1.png" size="27" isUploading="false" initialPath="Resources/Images/googlebc1.png" githubPath="ENU/Resources/Images/googlebc1.png" position="flex-start" indent="2"></Image>

3. Click **Security and MDM partners** > **Manage**.

<Image src="Resources/Images/googlebc2.png" size="26" isUploading="false" initialPath="Resources/Images/googlebc2.png" githubPath="ENU/Resources/Images/googlebc2.png" position="flex-start" indent="2"></Image>

4. In the **Manage Partner Connections** window, select **Ivanti**.

<Image src="Resources/Images/googlebc3.png" size="23" isUploading="false" initialPath="Resources/Images/googlebc3.png" githubPath="ENU/Resources/Images/googlebc3.png" position="flex-start" indent="2"></Image>
...
<Image src="Resources/Images/googlebc5.png" size="28" isUploading="false" initialPath="Resources/Images/googlebc5.png" githubPath="ENU/Resources/Images/googlebc5.png" position="flex-start" indent="2"></Image>
...
<Image src="Resources/Images/googlebc7.png" size="28" isUploading="false" initialPath="Resources/Images/googlebc7.png" githubPath="ENU/Resources/Images/googlebc7.png" position="flex-start" indent="2"></Image>

8. Go to **Security** > **Context Aware Access** > **Access level**, select the application for which you would like to assign the policy.

<Image src="Resources/Images/googlebc9.png" size="28" isUploading="false" initialPath="Resources/Images/googlebc9.png" githubPath="ENU/Resources/Images/googlebc9.png" position="flex-start" indent="2"></Image>

9. Click **Assign**.
10. From the **Select access levels** window, select the policies you want to assign and click **Save**.

<Image src="Resources/Images/googlebc11.png" size="28" isUploading="false" initialPath="Resources/Images/googlebc11.png" githubPath="ENU/Resources/Images/googlebc11.png" position="flex-start" indent="2"></Image>
