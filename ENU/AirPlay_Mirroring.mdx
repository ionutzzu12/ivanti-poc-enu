...
- [Configuring Apple AirPlay](AirPlay_Mirroring.mdx)
- [Setting up AirPlay on the mobile device](AirPlay_Mirroring.mdx)
- [Setting up a monitor to work with Apple TV](AirPlay_Mirroring.mdx)
- [Connecting your iOS device to Apple TV](AirPlay_Mirroring.mdx)

## Configuring Apple AirPlay

For more information on AirPlay configuration settings, see [AirPlay Configuration](AirPlay_Configuration.mdx).
...
1. Setup [Apple Configurator](Apple_Configurator.mdx).
