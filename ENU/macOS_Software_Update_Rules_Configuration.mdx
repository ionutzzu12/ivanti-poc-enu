...
Administrators can configure the software update policy of a device by defining the [macOS Software Update Rules](macOS_Software_Update_Rules_Configuration.mdx).
...
4. Select the required configurations from [macOS Software Update Rules](macOS_Software_Update_Rules_Configuration.mdx).
5. Click Next.
