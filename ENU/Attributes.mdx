...
<WorkflowBlock>
  ...
  <WorkflowBlockItem>
    ...
    - **Device**
    - **App**
    - **IDP** (for more information, see [User Provisioning with SCIM ](User_Provisioning_with_SCIM.mdx)or [Connect Ivanti Neurons for MDM with Entra ID User Source](Connect_Ivanti_Neurons_for_MDM_with_Entra_ID_User_Source.mdx))
