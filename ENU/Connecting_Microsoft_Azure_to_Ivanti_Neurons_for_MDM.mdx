...
- To disconnect the account, click Disconnect Account. For additional instructions, see [De-provisioning of the Azure tenant](De-provisioning_of_the_Azure_tenant.mdx).
