...
- [Implement policies](Working_with_Policies.mdx)
- [Compliance Actions](Working_with_Policies.mdx)
- [Finding an existing policy](Working_with_Policies.mdx)
- [Adding a policy](Working_with_Policies.mdx)
- [Editing a policy](Working_with_Policies.mdx)
- [Deleting a policy](Working_with_Policies.mdx)
...
7. Check the violation reason in the **Violation** column. It will be one of the following reasons\:Priority (1 = highest)
   ...
   \| [Allowed Apps](Monitoring_and_Controlling_Allowed_Apps.mdx)                 | Flags devices that violate rules about which apps are allowed or required.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
   \| [Custom Policy](Custom_Policy.mdx)               | Creates a custom policy based on conditions and related actions you specify.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
...
If you cannot see the Policies page, it might be that you do not have the required permissions. You need one of the following [roles](User_Roles.mdx):
