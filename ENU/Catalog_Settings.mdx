...
- [Changing Apple App Management settings](Catalog_Settings.mdx)
- [Setting Default App Store Region](Catalog_Settings.mdx)
- [Enabling/disabling iOS app updates](Catalog_Settings.mdx)
- [Enabling/disabling application ratings and reviews](Catalog_Settings.mdx)
- [Uploading or updating an iOS/macOS Apps and Books sToken (License: Gold)](Catalog_Settings.mdx)
- [Removing an iOS/macOS Apps and Books sToken from your Ivanti Neurons for MDM service](Catalog_Settings.mdx)
...
5. Go to the [Apple Apps and Books](Apple_Apps_and_Books.mdx) page to view the apps associated with this token.
...
If you cannot perform tasks on the **Catalog Settings** page, it might be that you do not have the required permissions. You need the following [role](User_Roles.mdx):
