...
3. Click **Choose File** to select the ADMX file to be uploaded.Make sure that the ADMX file is a zip file.
4. Click **Append**. A confirmation message is displayed for a successful upload.Make sure that the root folder contains the *.admx* extension file after unzipping the zip file.
