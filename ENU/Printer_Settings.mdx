...
Ivanti Neurons for MDM allows you to create printer profiles and add them to devices. This feature requires Bridge. See [Bridge](Ivanti_Bridge.mdx) for details.
