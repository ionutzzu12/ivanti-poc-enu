---
title: Changing the Device Name
docTags: 
...
3. Perform one of the following steps:\* Add the **Device Name** column if not already added by clicking the Settings gear icon on the right and selecting **Device Name**.
