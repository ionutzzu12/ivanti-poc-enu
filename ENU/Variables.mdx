...
- [Supported user account variables](Variables.mdx)
- [Supported device variables](Variables.mdx)

## Supported user account variables

### User Variables

<Image src="awvariables.png" size="18" isUploading="false" initialPath="awvariables.png" githubPath="ENU/awvariables.png" position="flex-start"></Image>
