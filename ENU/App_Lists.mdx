...
Now you can use this list when you configure the [Allowed Apps](Monitoring_and_Controlling_Allowed_Apps.mdx) policy.

If you cannot see the **App Lists** page, it might be that you do not have the required permissions. You need one of the following [roles](User_Roles.mdx):
