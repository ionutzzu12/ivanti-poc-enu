...
- [Bridge supported file types](Ivanti_Bridge.mdx)
- [Bridge setup](Ivanti_Bridge.mdx)
- [Bridge Logs](Ivanti_Bridge.mdx)
- [Bridge Last Check-in](Ivanti_Bridge.mdx)
- [Bridge Service Failure Recovery](Ivanti_Bridge.mdx)
...
1. [Activating Bridge licenses](Ivanti_Bridge.mdx)
2. [Installing the Bridge application](Ivanti_Bridge.mdx)
3. [Uploading scripts to the devices](Ivanti_Bridge.mdx) for permanent or one time use to the devices
