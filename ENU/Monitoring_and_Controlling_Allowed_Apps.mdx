...
- The [privacy configuration](Privacy_Configuration.mdx) assigned to a device must allow collection of app information in order for an Allowed Apps policy to work correctly. Check the privacy configurations assigned to the devices to which you will apply the Allowed Apps policy.

If you are not sure which configurations are affected:

1. Go to **Policies**.

<Image src="r44allowedapps001.png" size="36" isUploading="false" initialPath="r44allowedapps001.png" githubPath="ENU/r44allowedapps001.png" position="flex-start" indent="2"></Image>

<Paragraph indent="1">
  Click **Allowed Apps**.
</Paragraph>

<Image src="allowed_app_privacy001.png" size="37" isUploading="false" initialPath="allowed_app_privacy001.png" githubPath="ENU/allowed_app_privacy001.png" position="flex-start" indent="2"></Image>
...
<WorkflowBlock>
  <WorkflowBlockItem>
    ...
    <Image src="r44allowedapps001.png" size="36" isUploading="false" initialPath="r44allowedapps001.png" githubPath="ENU/r44allowedapps001.png" position="flex-start"></Image>
  </WorkflowBlockItem>

  <WorkflowBlockItem>
    Click **Allowed Apps**.

    <Image src="r44allowedapps001a.png" size="46" isUploading="false" initialPath="r44allowedapps001a.png" githubPath="ENU/r44allowedapps001a.png" position="flex-start"></Image>
  </WorkflowBlockItem>
  ...
  <WorkflowBlockItem>
    ...
    <Image src="Resources/Images/AllowedApps_EnablingAndroidEnterprise.png" size="29" isUploading="false" initialPath="Resources/Images/AllowedApps_EnablingAndroidEnterprise.png" githubPath="ENU/Resources/Images/AllowedApps_EnablingAndroidEnterprise.png" position="flex-start" indent="2"></Image>
  ...
  <WorkflowBlockItem>
    :inlineImage[]{src="https://api.archbee.com/api/optimize/BbT7KQqqvz3LSYn2rwmao/FE-hnabSQMF6rqr_nozZ4_r44allowedapps003a.png" alt caption}
  ...
  <WorkflowBlockItem>
    ...
    - You can customize the messages by including optional substitution variables to provide recipients more details about policy violations and other relevant information. Click the following attribute types to display the complete list of variables:
      ...
      - Custom Device/User/LDAP attributes that are created from the **Admin > Attributes** page.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
        ...
        The Allowed Apps policy supports [tiered compliance actions](Custom_Policy.mdx) if you have a Platinum license.
