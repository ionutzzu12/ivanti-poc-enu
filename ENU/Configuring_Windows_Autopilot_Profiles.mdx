...
1. Integrate Entra ID tenants and Ivanti Neurons for MDM. For more information, see [Setup with Microsoft Azure](Setup_with_Microsoft_Azure.mdx).
...
8. You can also create a Entra ID Device Group and assign the Autopilot Profile to this newly created group. See [Creating Entra ID Device Groups](Configuring_Windows_Autopilot_Profiles.mdx) for more information.
