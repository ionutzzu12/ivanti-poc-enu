...
- [Establish a connection with Ivanti Neurons for MDM](User_Provisioning_for_Okta_IdP.mdx)
- [Provision users and groups](User_Provisioning_for_Okta_IdP.mdx)
- [Verify assigned user provisioning](User_Provisioning_for_Okta_IdP.mdx)
- [Verify group provisioning](User_Provisioning_for_Okta_IdP.mdx)
- [Edit Settings](User_Provisioning_for_Okta_IdP.mdx)
- [Configure Custom/ Enterprise Attributes in SCIM User Provisioning](User_Provisioning_for_Okta_IdP.mdx)
