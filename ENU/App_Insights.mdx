...
- [Viewing app distribution](App_Insights.mdx)
- [Viewing app details](App_Insights.mdx)
- [Adding single app distribution charts](App_Insights.mdx)
- [Adding a unmanaged iOS apps chart](App_Insights.mdx)
- [Adding top 10 installed managed apps](App_Insights.mdx)
- [Adding top 5 rated in-house apps](App_Insights.mdx)
