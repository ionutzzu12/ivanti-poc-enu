...
You can give users access to Ivanti Neurons for MDM data and features by assigning [roles](User_Roles.mdx). You can assign roles directly to users or to user groups. Assigning a role to a user group gives that role to all users in that group.
...
For more information about roles, see [Roles\_Management.htm](Roles_Management.mdx).
