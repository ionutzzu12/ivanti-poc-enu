...
6. Select one of the distribution options to set up the **Safari Extension Settings** configuration. For more information about configuring distribution options, see [Working with Configurations](Working_with_Configurations.mdx).
7. Click **Done**.
