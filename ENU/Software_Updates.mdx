...
- [Configuring software updates for iOS/tvOS devices](Software_Updates.mdx)
- [Configuring software updates for Non-DEP and DEP macOS devices](Software_Updates.mdx)
- [Configuring software updates for Windows devices](Software_Updates.mdx)
- [Software Updates Enforcement using Declarative Device Management](Software_Updates.mdx)
...
- Enable `enforcedSoftwareUpdateDelay` in [iOS Restrictions](iOS_Restrictions.mdx) to make sure the manual scan on devices for software updates will not delete the specific versions downloaded by this configuration.

## Configuring software updates for Non-DEP and DEP macOS devices

Device Enrollment profile is part of Apple Business Manager that enables customers to purchase devices in bulk and automatically enroll the devices in MDM during activation. For more information, see [Device Enrollment](Device_Enrollment.mdx).
