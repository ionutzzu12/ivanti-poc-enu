...
- [Launching Kiosk Mode remotely](Setting_up_Kiosk_Mode_for_Android.mdx)
- [Exiting Kiosk Mode](Setting_up_Kiosk_Mode_for_Android.mdx)
...
When preparing Android devices for Kiosk mode or Device Owner with Kiosk mode, you will need to [create a Allowlist of apps](App_Control_Configuration__Control_Which_Apps_Are_Installed_Per_Device.mdx) that you want to be available to users in Kiosk Mode. For devices using Device Owner you can add apps to the allowed apps list by dragging and dropping to arrange the apps in the order they should appear in the Kiosk Mode launcher when configuring the app. See [Lockdown & Kiosk configuration](Lockdown___Kiosk__Android_Device_Admin_Mode.mdx) for more information.
...
- (Optional) Set up [Android kiosk branding](Admin___Android_Kiosk_Branding.mdx).
