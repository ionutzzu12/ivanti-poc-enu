...
- [Solution Overview](Getting_Started.mdx)&#x20;
  - [Key features](Getting_Started.mdx)
  - [Architecture diagram](Getting_Started.mdx)
  - [Ivanti Neurons for MDM applications](Getting_Started.mdx)
  - [Roles](Getting_Started.mdx)
  - [Getting started](Getting_Started.mdx)
- [Setting preferred language in a browser](Getting_Started.mdx)
- [Unified navigation interface for Ivanti Neurons for MDM and Access](Getting_Started.mdx)
- [Device Admin (DA) mode to manage Android devices - deprecated](Getting_Started.mdx)
...
<Image src="Resources/Images/Zero Trust.png" size="58" alt="This diagram shows the solution overview with all the components that help enterprises provide a mobile-centric zero trust architecture for the hybrid enterprise" isUploading="false" initialPath="Resources/Images/Zero Trust.png" githubPath="ENU/Resources/Images/Zero Trust.png" position="flex-start" width="1276" height="727" darkWidth="1276" darkHeight="727"></Image>
...
<Image src="Resources/Images/Architecture Diagram.png" size="59" alt="This image depicts the Ivanti Neurons for MDM architecture diagram" isUploading="false" initialPath="Resources/Images/Architecture Diagram.png" githubPath="ENU/Resources/Images/Architecture Diagram.png" position="flex-start" width="1288" height="730" darkWidth="1288" darkHeight="730"></Image>
...
<Image src="Resources/Images/Apps.png" size="56" alt="This image depicts the Ivanti Neurons for MDM applications" isUploading="false" initialPath="Resources/Images/Apps.png" githubPath="ENU/Resources/Images/Apps.png" position="flex-start" width="1237" height="703" darkWidth="1237" darkHeight="703"></Image>
...
**User** – As an Enterprise User, you can seamlessly access business applications and personal data from secure modern mobile devices, desktops, and cloud services. For more information about the various tasks that you can perform as a user, see [Users](Users.mdx). and [Roles Management](Roles_Management.mdx).
...
<Image src="Resources/Images/Quick Start Flow Diag.png" size="41" alt="This image depicts the Ivanti Neurons for MDM UEM quick start workflow" isUploading="false" initialPath="Resources/Images/Quick Start Flow Diag.png" githubPath="ENU/Resources/Images/Quick Start Flow Diag.png" position="flex-start" width="901" height="705" darkWidth="901" darkHeight="705"></Image>

**Procedure**

<WorkflowBlock>
  <WorkflowBlockItem>
    Click the URL provided in the tenant registration email. The password reset prompt appears.
  </WorkflowBlockItem>
  ...
  <WorkflowBlockItem>
    Log in to the tenant account using the ID and password. The Welcome wizard appears.
  </WorkflowBlockItem>

  <WorkflowBlockItem>
    Complete the details in the **Welcome** form, accept the terms and agreement, and click **Continue**.
  </WorkflowBlockItem>

  <WorkflowBlockItem>
    To install iOS MDM certificate, see [Install MDM Certificate](Install_MDM_Certificate.mdx).If you want to manage your iOS devices at a later point in time, you can skip the iOS MDM certificate installation. Then the wizard prompts you to register the Android devices of your enterprise. Skipping the iOS MDM certificate installation means iOS devices will not be able to register. Users will see a message stating that iOS device enrollment has not been enabled.
  </WorkflowBlockItem>

  <WorkflowBlockItem>
    To register the Android devices in Android Enterprise (AE) mode, see [Managed Google Play Accounts (Android Enterprise Accounts)](Managed_Google_Play_Accounts__Android_Enterprise_Accounts_.mdx). The wizard then prompts you to setup email accounts.If you want to manage your Android devices at a later point in time, you can skip the Android managed Google Play account enrollment. Skipping the Managed Google Play Account enrollment will not allow you to register Android enterprise devices. Android devices can still be registered with Device Admin, but key features such as Managed Google Play, and App Configuration will not be available for use.
  </WorkflowBlockItem>

  <WorkflowBlockItem>
    To configure the email settings and ActiveSync, see [Exchange Configuration](Exchange_Configuration.mdx) and [Email Configuration](Email_Configuration.mdx).
  </WorkflowBlockItem>

  <WorkflowBlockItem>
    Click **Continue**. The pass code creation prompt appears.
  </WorkflowBlockItem>

  <WorkflowBlockItem>
    Select a pass code type and click **Continue**.
  </WorkflowBlockItem>

  <WorkflowBlockItem>
    Select the applications you want to upload and click **Continue**.
  </WorkflowBlockItem>

  <WorkflowBlockItem>
    Specify the email addresses of the users and click **Continue**. The users will receive an email to register their mobile devices. A summary of the configuration is displayed.
  </WorkflowBlockItem>

  <WorkflowBlockItem>
    Click **Finished**. The Dashboard page is displayed.
  </WorkflowBlockItem>

  <WorkflowBlockItem>
    To explore further, do the following:
...
For more information about the various tasks that you can perform as an administrator, see the [Admin](Admin.mdx) section.
...
- Product picker in the left navigation pane to switch between Ivanti Neurons for MDMand Access products.
