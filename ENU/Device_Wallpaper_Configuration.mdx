---
title: Device Wallpaper Configuration
docTags: 
...
6. Select one of the following distribution options:\* **All Devices**
   - **No Devices** (default)
   - **Custom**
7. Click **Done**.The uploaded image must be in .jpg or .png format.
...
6. Select one of the following options:\* **All Devices**
   - **No Devices** (default)
   - **Custom**
7. Click **Done**.The uploaded images must be 1164H x 640W and in .jpg or .png format.
...
6. Click **Next**.
7. Select one of the following options:\* **All Devices**
   - **No Devices** (default)
   - **Custom**
8. Click **Done**
