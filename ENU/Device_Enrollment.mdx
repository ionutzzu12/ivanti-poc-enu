...
<WorkflowBlock>
  ...
  <WorkflowBlockItem>
    The selected option overrides the selections under [User Settings](User_Settings.mdx).
  ...
  <WorkflowBlockItem>
    ...
    - **Beta Program for macOS** : Enforces beta software versions on macOS during Automated Device Enrollment. |
      ...
      \| MDM Removable                                  | Defines whether the user will be unable to unenroll from MDM after the device is registered.This setting is not applicable to [Shared iPads](Shared_iPad_devices_for_business.mdx).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
