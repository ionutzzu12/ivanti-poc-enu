...
5. For Windows, configure the following **Energy Saver** settings:\* [Device on Battery](Energy_Saver_Configuration.mdx)
   - [Device is Plugged in](Energy_Saver_Configuration.mdx)
6. Configure the following **Energy Saver** settings:\* [Desktop AC power energy-saver settings](Energy_Saver_Configuration.mdx)
   - [Schedule for the computer to start up or shut down settings](Energy_Saver_Configuration.mdx)
   - [Laptop AC power energy-saver settings](Energy_Saver_Configuration.mdx)
   - [Laptop battery power energy-saver settings](Energy_Saver_Configuration.mdx)
7. Click **Next** to configure the distribution settings.
8. Select one of the distribution options to set up the **Energy Saver** configuration. For more information about configuring distribution options, see [Working with Configurations](Working_with_Configurations.mdx).
9. Click **Done**.
