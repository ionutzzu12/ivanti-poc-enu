...
- [Licensing for app features](App_Catalog.mdx)
- [Switching between list and grid view](App_Catalog.mdx)
- [Adding Google Play Store app for Android Enterprise](App_Catalog.mdx)
- [Adding an app from a public store](App_Catalog.mdx)
- [Adding an in-house app](App_Catalog.mdx)
- [Delegating device permissions for Android Enterprise In-house apps](App_Catalog.mdx)
- [Displaying the provisioning profile status for iOS in-house apps](App_Catalog.mdx)
- [Updating provisioning profile for iOS in-house apps](App_Catalog.mdx)
- [Deploying in-house apps to Google Play](App_Catalog.mdx)
- [Adding a web app for Android Enterprise devices](App_Catalog.mdx)
- [Adding a web app for iOS devices](App_Catalog.mdx)
- [Using Advanced Search](App_Catalog.mdx)
- [Exporting Apps to a CSV file](App_Catalog.mdx)
...
- Public apps are not supported on [Shared iPads](Shared_iPad_devices_for_business.mdx).
...
- [Android Enterprise](Setting_up_Android_Enterprise.mdx) custom configuration: Silver license
...
<Image src="cloudr38grid001.png" size="46" isUploading="false" initialPath="cloudr38grid001.png" githubPath="ENU/cloudr38grid001.png" position="flex-start"></Image>
    ...
    <WorkflowBlock>
      ...
      <WorkflowBlockItem>
        ...
        - The device is a Samsung Knox device and the silent installation option below has been selected.For iOS public apps, when installed for the first time in the device, the App Catalog displays 'Reinstall' button that allows the user to install the app again.The reinstall is performed if app version on device is different from the version on iOS app store. |
          ...
          \| (iOS and macOS only) Enable Per-App VPN for this app                | Select this option to use a [Per-App VPN configuration](Per-app_VPN_Configuration.mdx) with this app.Select the Per App VPN configuration to be used from the drop-down list.For macOS, select Tunnel Per App VPN configuration only.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
          ...
          [Android Enterprise](Setting_up_Android_Enterprise.mdx) apps will have different options.
...
<WorkflowBlock>
  ...
  <WorkflowBlockItem>
    ...
    <WorkflowBlockItem>
      Configure [app delegation](Delegating_Apps.mdx).
    </WorkflowBlockItem>
  ...
  <WorkflowBlockItem>
    ...
    - **Detection Scripts**: Enter the script name that server sends to a device to detect an app. The result of the detection script of the app overrides the default inventory result of the app on the device. Irrespective of whether the App is distributed to the device or not, the detection script of all apps will be sent to the device to evaluate the existence of the apps on the device.
      ...
      You can create the scripts in the **Admin >&#xA0;**[ All Scripts](All_Scripts.mdx) page. If you upgrade the app, you can choose to copy the scripts from the older app and run the scripts for the upgraded app. If you skip this section, you can configure scripts by editing the app later.
...
<Image src="Resources/Images/1.png" size="10" isUploading="false" initialPath="Resources/Images/1.png" githubPath="ENU/Resources/Images/1.png" position="flex-start"></Image>

, the Prerequisite Apps feature to search for,

<Image src="Resources/Images/2.png" size="10" isUploading="false" initialPath="Resources/Images/2.png" githubPath="ENU/Resources/Images/2.png" position="flex-start"></Image>

, and select,

<Image src="Resources/Images/3.png" size="10" isUploading="false" initialPath="Resources/Images/3.png" githubPath="ENU/Resources/Images/3.png" position="flex-start"></Image>

, prerequisite apps that must be installed on clients before the app the admin is importing can be installed.

<Image src="Resources/Images/62_mip005.png" size="57" isUploading="false" initialPath="Resources/Images/62_mip005.png" githubPath="ENU/Resources/Images/62_mip005.png" position="flex-start"></Image>

Once imported, the Packager macOS in-house app appears in the app catalog with the

<Image src="Resources/Images/MIPBadge.png" size="10" isUploading="false" initialPath="Resources/Images/MIPBadge.png" githubPath="ENU/Resources/Images/MIPBadge.png" position="flex-start"></Image>
...
<Image src="Resources/Images/62_mip010.png" size="54" isUploading="false" initialPath="Resources/Images/62_mip010.png" githubPath="ENU/Resources/Images/62_mip010.png" position="flex-start"></Image>
...
<Image src="Resources/Images/62mip_turnoffporompt001.png" size="34" isUploading="false" initialPath="Resources/Images/62mip_turnoffporompt001.png" githubPath="ENU/Resources/Images/62mip_turnoffporompt001.png" position="flex-start"></Image>
...
If there are any issues with using this feature, administrators can contact [Support](Opening_a_Support_Ticket.mdx).
...
<WorkflowBlock>
  ...
  <WorkflowBlockItem>
    ...
    <Image src="Resources/Images/web-apps-google-play.png" size="50" caption="Adding Web apps for Android enterprise" alt="Adding Web apps for Android enterprise" isUploading="false" initialPath="Resources/Images/web-apps-google-play.png" githubPath="ENU/Resources/Images/web-apps-google-play.png" position="flex-start"></Image>
  </WorkflowBlockItem>

  <WorkflowBlockItem>
    Describe the app for users:

    <Image src="Resources/Images/web-apps-google-play-details.png" size="47" caption="Web app details" alt="Web app details" isUploading="false" initialPath="Resources/Images/web-apps-google-play-details.png" githubPath="ENU/Resources/Images/web-apps-google-play-details.png" position="flex-start"></Image>
  </WorkflowBlockItem>
