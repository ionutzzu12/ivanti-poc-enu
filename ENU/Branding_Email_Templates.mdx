...
- [Previewing and testing an email template](Branding_Email_Templates.mdx)
- [Customizing the message headers](Branding_Email_Templates.mdx)
- [Customizing an email template](Branding_Email_Templates.mdx)
- [Supported email variables](Branding_Email_Templates.mdx)
...
<Image src="r45emailtemplates003.png" size="35" isUploading="false" initialPath="r45emailtemplates003.png" githubPath="ENU/r45emailtemplates003.png" position="flex-start" indent="2"></Image>
...
5. Edit the email template containing HTML elements in the body pane to customize the message content.|                    |                                                                                                                    |
   \| ------------------ | ------------------------------------------------------------------------------------------------------------------ |
   \| :inlineImage[]{src="https://api.archbee.com/api/optimize/BbT7KQqqvz3LSYn2rwmao/e_ESs4BbLSU2XlMRzC9OR_infoicon.png" alt caption} | You can use the variables displayed on the right in the body of the email. See [Supported email variables](Branding_Email_Templates.mdx). |
...
<Image src="r45emailtemplates004.png" size="19" isUploading="false" initialPath="r45emailtemplates004.png" githubPath="ENU/r45emailtemplates004.png" position="flex-start" indent="2"></Image>
...
An admin can use [custom user attributes](Attributes.mdx) as email variables in the customized email template under the following conditions:
