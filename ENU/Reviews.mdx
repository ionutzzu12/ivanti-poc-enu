...
- [Viewing ratings and reviews](Reviews.mdx)
- [Disabling ratings and reviews](Reviews.mdx)
- [Deleting a review](Reviews.mdx)
- [Exporting reviews to a CSV file](Reviews.mdx)
...
If you cannot perform tasks on the **Reviews** page, it might be that you do not have the required permissions. You need one of the following [role](User_Roles.mdx):
