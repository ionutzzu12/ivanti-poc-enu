...
Delegation with custom distribution option is available for this configuration. For more information, see *Distributing the configuration* topic in [Working with Configurations](Working_with_Configurations.mdx).
...
- [L2TP](VPN_Configuration.mdx) (Not supported on Ivanti Go)
- [PPTP](VPN_Configuration.mdx) (Not supported on Ivanti Go)
- [IPsec (Cisco)](VPN_Configuration.mdx) (Not supported on Ivanti Go)
- [Cisco AnyConnect](VPN_Configuration.mdx) (Supported on Ivanti Go)
- [Juniper SSL](VPN_Configuration.mdx) (Not supported on Ivanti Go)
- [NetMotion VPN](VPN_Configuration.mdx) (Not supported on Ivanti Go)
- Pulse Secure (Supported on Ivanti Go)
- [F5 SSL](VPN_Configuration.mdx) (Not supported on Ivanti Go)
- [SonicWALL Mobile Connect](VPN_Configuration.mdx) (Not supported on Ivanti Go)
- [Aruba VIA](VPN_Configuration.mdx) (Not supported on Ivanti Go)
- [Custom SSL](VPN_Configuration.mdx) (Not supported on Ivanti Go)
- [Palo Alto Networks GlobalProtect](VPN_Configuration.mdx) (Supported on Ivanti Go)
- [KEv2 (Windows Only)](VPN_Configuration.mdx) (Not supported on Ivanti Go)
- [IKEv2](VPN_Configuration.mdx) (Not supported on Ivanti Go)
