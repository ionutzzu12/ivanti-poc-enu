...
- [License distribution of apps across multiple Apple Apps and Books accounts in a space](Apple_Apps_and_Books.mdx)
- [Device-based and user-based license distribution](Apple_Apps_and_Books.mdx)
- [Using device-based license option](Apple_Apps_and_Books.mdx)
- [Using user-based license option](Apple_Apps_and_Books.mdx)
- [Adding a Apps and Books app to the catalog](Apple_Apps_and_Books.mdx)
- [Adding Apps and Books accounts](Apple_Apps_and_Books.mdx)
- [Updating a Apps and Books secure token](Apple_Apps_and_Books.mdx)
- [Updating the priority of a Apps and Books account](Apple_Apps_and_Books.mdx)
- [Deleting a Apps and Books secure token](Apple_Apps_and_Books.mdx)
- [Distributing licenses for a Apps and Books app in the catalog](Apple_Apps_and_Books.mdx)
- [Viewing app licenses per user](Apple_Apps_and_Books.mdx)
- [Apps and Books license usage notifications](Apple_Apps_and_Books.mdx)
- [Viewing Apps and Books license usage](Apple_Apps_and_Books.mdx)
- [Revoking Apps and Books license for an app](Apple_Apps_and_Books.mdx)
- [Apps and Books behavior for macOS and iOS devices](Apple_Apps_and_Books.mdx)
- [Apps and Books license entitlement when a device moves spaces](Apple_Apps_and_Books.mdx)

**License:** Silver

The **Apple Apps and Books** screen is available only if you have set up Apple Apps and Books in your [app catalog settings](Catalog_Settings.mdx). This screen shows the app licenses that have been purchased for Apple devices via the Apple Apps and Books and how many have been used. Use this screen to:
...
In the case of [Shared iPads](Shared_iPad_devices_for_business.mdx), Apps and Books are installed based on device-based licenses regardless of whether device-based licenses are selected or not.
...
<WorkflowBlock>
  ...
  <WorkflowBlockItem>
    ...
    Click on the notification title to see the details. See [Dashboard](Dashboard.mdx) for the available notifications.
  </WorkflowBlockItem>
</WorkflowBlock>
...
If you cannot perform tasks on the **App Categories** page, it might be that you do not have the required permissions. You need one of the following [role](User_Roles.mdx):
