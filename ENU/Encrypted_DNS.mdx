...
- [Encrypted DNS configuration](Encrypted_DNS.mdx)
- [Encrypted DNS configuration settings](Encrypted_DNS.mdx)
...
5. Enter the [Encrypted DNS configuration settings](Encrypted_DNS.mdx).
6. Click **Next**.
