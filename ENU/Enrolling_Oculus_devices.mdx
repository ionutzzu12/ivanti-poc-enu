...
- Prerequisites to enrolling Oculus devices
  - [Setting up an MDM app in the Device Manager](Enrolling_Oculus_devices.mdx)
  - [Setting up the Oculus device](Enrolling_Oculus_devices.mdx)
    Register an OFB device with MobileIron Go
  - [On Ivanti Neurons for MDM Console](Enrolling_Oculus_devices.mdx)
  - [On Go client](Enrolling_Oculus_devices.mdx)
