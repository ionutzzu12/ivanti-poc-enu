...
5. Select one of the distribution options to set up the **Cellular Private Network** configuration. For more information about configuring distribution options, see [Working with Configurations](Working_with_Configurations.mdx).
6. Click **Done**.
