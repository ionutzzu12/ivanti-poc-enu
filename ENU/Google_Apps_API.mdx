...
8. Click **Save**.
9. If you cannot see the Google Apps API page, it might be that you do not have the required permissions. You need one of the following [roles](User_Roles.mdx):
   - System Management
   - System Read Only
