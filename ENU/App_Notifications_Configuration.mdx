---
title: App Notifications Configuration
docTags: 
...
7. Configure the notification settings. Here are the notifications you can select:\* Allow Notifications- Show in Notification Center
   - Sounds
   - Badge App Icon
   - Show on Lock Screen
   ...
   - Unlock Alert Style\* Banners
     - Modal Alert
     - None
   - (iOS 12.0+ Supervised) Grouping Type\* Automatic
     - By app
     - Off
   - (iOS 14.0+) Notification Preview Type - Select a preview type to display in device notification message previews.\* User Controlled - Display message previews as per user settings for the apps on the device.
