...
- [Filtering the display of configurations](Working_with_Configurations.mdx)
- [Adding a configuration](Working_with_Configurations.mdx)
- [Distributing the configuration](Working_with_Configurations.mdx)
- [Pushing configurations to multiple devices](Working_with_Configurations.mdx)
- [Excluding configurations](Working_with_Configurations.mdx)
- [Pushing an excluded configuration](Working_with_Configurations.mdx)
- [Exporting configurations](Working_with_Configurations.mdx)
- [Importing configuration](Working_with_Configurations.mdx)
- [Editing a configuration](Working_with_Configurations.mdx)
- [Deleting configurations](Working_with_Configurations.mdx)
- [Schedule in-house application updates](Working_with_Configurations.mdx)
...
There are many [types of configurations](Configuration_Types.mdx) available. They fall into the following basic categories:
...
If you cannot see the Configurations page, it might be that you do not have the required permissions. You need one of the following [roles](User_Roles.mdx):
