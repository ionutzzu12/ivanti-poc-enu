...
- [Distributing Hosted Content](Managing_Content.mdx)
- [Deleting content](Managing_Content.mdx)
...
If you cannot perform tasks on the **Content** page, it might be that you do not have the required permissions. You need the following [role](User_Roles.mdx):
