...
- [Setting up Sentry to use AppTunnel with certificates](Setting_Up_AppTunnel.mdx)
- [Uploading Sentry certificates](Setting_Up_AppTunnel.mdx)
- [Setting up apps to use AppTunnel](Setting_Up_AppTunnel.mdx)
- [About the AppTunnel service name](Setting_Up_AppTunnel.mdx)
...
- If you intend to use a SCEP identity:\* Add a local or [external certificate authority](Certificate_Management.mdx). A Connector installation is required.
...
5. Use the guidelines in the following table to complete the **Global Settings** page.| Table: Global Settings for Admin > Sentry             |                                                                                                                                                                                                                                                                                                                                                                                                      |
   ...
   \| **Use a single certificate for 2-factor auth**        | Select to use a single certificate for authentication. If you do not already have a [certificate uploaded](Certificate_configuration.mdx), you can do so in the area displayed below the selected option.                                                                                                                                                                                          |
