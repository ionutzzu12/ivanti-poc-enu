...
- [Configure Windows Desktop restrictions](Windows_Desktop_restrictions.mdx)
- [Creating a Allowlist for removable storage devices](Windows_Desktop_restrictions.mdx)
...
This feature requires Bridge. See [Ivanti Bridge](Ivanti_Bridge.mdx) for details.
