...
- [Installing the management profile manually](Device_Registration__iOS__macOS__and_Android_.mdx)
- [Sending an invitation (iOS, macOS, and Android)](Device_Registration__iOS__macOS__and_Android_.mdx)
- [Instructing end users to download the app (iOS and Android)](Device_Registration__iOS__macOS__and_Android_.mdx)
...
- **Password**: If specified in the [User Settings](User_Settings.mdx) and a temporary password is defined by the administrator
...
If you do not yet have a password defined for your Ivanti Neurons for MDM user account or if your [User Settings](User_Settings.mdx) require a registration PIN, a one-time use PIN is included . After you enter the PIN, you are prompted to set a password for the account if the password does not exist.
...
The Audit Trails page lists the device registration, re-registration, and retired statuses for Android devices. For more information, see [Working with Widgets](Working_with_Widgets.mdx).
