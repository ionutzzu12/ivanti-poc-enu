...
If you cannot see the **Install Apple Configurator** page, it might be that you do not have the required permissions. You need one of the following [roles](User_Roles.mdx):
